...
SELECT 'ESO'
WHERE NOT EXISTS (SELECT 1 FROM DEPARTMENT WHERE LOWER(DEPARTMENT_NAME) = LOWER('ESO'));

INSERT INTO DEPARTMENT (DEPARTMENT_NAME)
SELECT 'Batxillerat'
WHERE NOT EXISTS (SELECT 1 FROM DEPARTMENT WHERE LOWER(DEPARTMENT_NAME) = LOWER('Batxillerat'));

INSERT INTO DEPARTMENT (DEPARTMENT_NAME)
SELECT 'FP'
WHERE NOT EXISTS (SELECT 1 FROM DEPARTMENT WHERE LOWER(DEPARTMENT_NAME) = LOWER('FP'));

INSERT INTO DEPARTMENT (DEPARTMENT_NAME)
SELECT 'Administració'
WHERE NOT EXISTS (SELECT 1 FROM DEPARTMENT WHERE LOWER(DEPARTMENT_NAME) = LOWER('Administració'));
...
-- Password: P@ssw0rd (hashed with PASSWORD_DEFAULT)
INSERT INTO USUARI (USERNAME, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD_HASH, PHONE_NUMBER, ROLE, IS_VERIFIED)
SELECT 'admin', 'Admin', 'User', 'admin@example.com', '$2y$10$JeXKPNfXq9/9qHqR5RqBwO0tMp6qWZXF6RzvM8T8eWkJX5L5.zZa6Vy', '000000000', 'ADMIN', 1
WHERE NOT EXISTS (SELECT 1 FROM USUARI WHERE LOWER(USERNAME) = 'admin');

INSERT INTO USUARI (USERNAME, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD_HASH, PHONE_NUMBER, ROLE, IS_VERIFIED)
SELECT 'responsable', 'Responsable', 'User', 'responsable@example.com', '$2y$10$JeXKPNfXq9/9qHqR5RqBwO0tMp6qWZXF6RzvM8T8eWkJX5L5.zZa6Vy', '000000000', 'RESPONSABLE', 1
WHERE NOT EXISTS (SELECT 1 FROM USUARI WHERE LOWER(USERNAME) = 'responsable');

INSERT INTO USUARI (USERNAME, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD_HASH, PHONE_NUMBER, ROLE, IS_VERIFIED)
SELECT 'tecnic', 'Tecnic', 'User', 'tecnic@example.com', '$2y$10$JeXKPNfXq9/9qHqR5RqBwO0tMp6qWZXF6RzvM8T8eWkJX5L5.zZa6Vy', '000000000', 'TECNIC', 1
WHERE NOT EXISTS (SELECT 1 FROM USUARI WHERE LOWER(USERNAME) = 'tecnic');

INSERT INTO USUARI (USERNAME, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD_HASH, PHONE_NUMBER, ROLE, IS_VERIFIED)
SELECT 'professor', 'Professor', 'User', 'professor@example.com', '$2y$10$JeXKPNfXq9/9qHqR5RqBwO0tMp6qWZXF6RzvM8T8eWkJX5L5.zZa6Vy', '000000000', 'PROFESSOR', 1
WHERE NOT EXISTS (SELECT 1 FROM USUARI WHERE LOWER(USERNAME) = 'professor');